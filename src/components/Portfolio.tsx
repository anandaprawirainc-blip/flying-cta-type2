          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 italic">
                &ldquo;DigitalBoost transformed our online presence completely. Our sales increased by 250% in just 6 months!&rdquo;
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 italic">
                &ldquo;Professional team with exceptional results. They understand our business and deliver beyond expectations.&rdquo;
              </p>
              <div className="flex text-yellow-400 mt-4">
                ⭐⭐⭐⭐⭐
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 italic">
                &ldquo;From local to national - DigitalBoost helped us expand to 5 new markets with incredible ROI.&rdquo;
              </p>
              <div className="flex text-yellow-400 mt-4">
                ⭐⭐⭐⭐⭐
              </div>
