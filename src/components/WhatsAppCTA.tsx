...
const WhatsAppCTA = () => {
  ...
  const message = language === 'en' 
    ? "Hi! I'm interested in your digital marketing services. Can we discuss my project?"
    : "Halo! Saya tertarik dengan layanan digital marketing Anda. Bisakah kita diskusikan proyek saya?";
  ...
  const buttonText = language === 'en' ? 'Chat with Us' : 'Chat dengan Kami';
  const tooltipText = language === 'en' ? 'Get Free Consultation' : 'Konsultasi Gratis';
